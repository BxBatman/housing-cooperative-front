...
class EditOccupant extends Component {
    ...
    sendEditManager() {
        ...
        axios.put("http://localhost:8080/occupant", {
            id: this.state.id,
            ...
            console.log(error);
            NotificationManager.error("Could not update");
        })
...
export default withNamespaces()(EditOccupant);